...
public class CreateContacttest4screenshot extends BaseClass{
...
//		soft.assertAll();
	...
	public void createContactWithSupportDate() throws EncryptedDocumentException, IOException {
		 String lastname = elib.getDataFromExcel("Sheet3", 4, 2)+jlib.getRandomNumber();	
			...
			File srcr = edriver.getScreenshotAs(OutputType.FILE);
			File dst = new File("./screenshot/"+lastname+".png");
			FileUtils.copyFile(srcr, dst);
